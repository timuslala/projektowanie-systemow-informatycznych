        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                    ...
                    {modules.length === 0 ? (
                        <p className="text-[#94a3b8]">No modules available.</p>
                    ) : (
                        modules.map(module => (
                            <Card key={module.id} className="cursor-pointer hover:border-indigo-500/50 transition-all">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-[#94a3b8]">Module Content</p>
                                    </div>
                                </div>
                            </Card>
                        ))
                ...
                <div className="space-y-6">
                    <h2 className="text-xl font-semibold text-white">Quizzes & Tests</h2>
                    {quizzes.length === 0 ? (
                        <p className="text-[#94a3b8]">No quizzes available.</p>
                    ) : (
                        quizzes.map(quiz => (
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-[#94a3b8]">{quiz.time_limit_in_minutes} mins</p>
                                        </div>
                                    </div>
