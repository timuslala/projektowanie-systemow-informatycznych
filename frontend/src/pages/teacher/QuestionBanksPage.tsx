    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-[1400px] mx-auto py-8 px-4">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 mb-2">Question Banks</h1>
                    <p className="text-slate-500">Manage your collections of questions for quizzes.</p>
                </div>
            ...
            {questionBanks.length === 0 ? (
                <div className="text-center py-12 bg-white rounded-lg border border-slate-200">
                    ...
                    <p className="text-slate-500 mb-6">Start by creating your first question bank to add questions.</p>
                    <Link to="/question-banks/create">
